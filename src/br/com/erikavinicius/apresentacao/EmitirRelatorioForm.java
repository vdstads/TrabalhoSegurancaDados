 ...
 * @author Erika
 */
public class EmitirRelatorioForm extends javax.swing.JFrame {
    ...
    public EmitirRelatorioForm(TrabalhoSeguranca trabalhoSeguranca, Usuario usuario) throws SQLException {
        initComponents();
    ...
    private void btnGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarRelatorioActionPerformed
        ...
        /*try {
            ...
            JRBeanCollectionDataSource fonteDados = new JRBeanCollectionDataSource(listaProjeto);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmitirRelatorioForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
